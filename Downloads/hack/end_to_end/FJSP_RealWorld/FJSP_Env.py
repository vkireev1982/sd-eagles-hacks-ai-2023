            ...
            if action[i] not in self.partial_sol_sequeence[i]:
                ...
                if self.rule != None:
                    mask1, mch_mask = DRs(self.mch_time[i], self.job_time[i], self.mchsEndTimes[i],
                                          ...
                                          self.mask[i], done, self.mask_mch[i], self.num_operation[i],
                    ...
                    mch_space, mchForJobSpace, mask1, mch_mask = min_job_mch(self.mch_time[i], self.job_time[i],
                                                                         ...
                                                                         self.dur_cp[i], self.temp1[i], self.omega[i],
                                                                         self.mask[i], done, self.mask_mch[i],self.first_col[i],self.last_col[i])
